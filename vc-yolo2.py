...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.VCThread = QThread(self)
        self.Worker1.moveToThread(self.VCThread)

        self.VCThread.started.connect(self.Worker1.run)
        self.VCThread.start()
