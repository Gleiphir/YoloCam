...
def convert_cv2qt(cv_img,width = 1024,height = 768):
...
class SimpleAsFuckGui(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.showLbl = QtWidgets.QLabel(self)

    @pyqtSlot(QImage)
    def setImage(self, image):
        self.showLbl.setPixmap(QPixmap.fromImage(image))
# Images
...
if __name__ == '__main__':
    ...
    hello_world_gui.showLbl.setGeometry(0, 0, 1024, 768)
    ...
    while True:
        ...
        print("set Image")
        hello_world_gui.setImage(convert_cv2qt(frame))
        #hello_world_gui.repaint()
        #input()
